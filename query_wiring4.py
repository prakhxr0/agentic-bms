import sqlite3
conn = sqlite3.connect('outputs/wiring_test2/eplusout.sql')
cursor = conn.cursor()
cursor.execute('SELECT ReportDataDictionaryIndex, Name, KeyValue FROM ReportDataDictionary WHERE Name = "Schedule Value" AND KeyValue IN ("HTG-SETP-SCH", "CLG-SETP-SCH")')
